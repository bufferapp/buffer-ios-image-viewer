Pod::Spec.new do |s|
    ...
    s.source       = { :git => "https://github.com/bufferapp/buffer-ios-image-viewer.git", :tag => '1.1.1'  }
    ...
    s.dependency 'PINRemoteImage', :git => 'https://github.com/pinterest/PINRemoteImage.git', :tag => '3.0.0-beta.12'
end
