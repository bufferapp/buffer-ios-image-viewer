...
/*! Assigning YES to this property will make ensure the first image doesn't load for 0.25f, so the custom view controller animation can finish putting the image in its final frame. */
